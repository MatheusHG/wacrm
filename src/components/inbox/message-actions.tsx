      ...
      >
        <Popover open={pickerOpen} onOpenChange={setPickerOpen}>
          <PopoverTrigger
            ...
            aria-label={t("inbox.messageActions.react")}
          >
          ...
          >
            {QUICK_EMOJIS.map((e) => (
              <button
                ...
                aria-label={t("inbox.messageActions.reactWith", { emoji: e })}
              >
                {e}
              </button>
            ))}
        ...
        <button
          ...
          onClick={handleReply}
          className="flex h-5 w-5 items-center justify-center rounded-full text-popover-foreground hover:bg-muted hover:text-foreground"
          aria-label={t("inbox.messageActions.reply")}
        >
        ...
        <button
          ...
          onClick={handleCopy}
          className="flex h-5 w-5 items-center justify-center rounded-full text-popover-foreground hover:bg-muted hover:text-foreground"
          aria-label={t("inbox.messageActions.copy")}
        >
